...
test('ui review chrome matches v4 mockup navigation and composer', () => {
  ...
  assert.match(css, /\.app-ui-review \.workflow-steps-title strong,\s*\n\.app-ui-review \.workflow-template-preview \.field-row-between > span\s*\{[\s\S]*border:\s*1px solid var\(--border\);[\s\S]*border-radius:\s*999px;[\s\S]*padding:\s*4px 9px;/)
