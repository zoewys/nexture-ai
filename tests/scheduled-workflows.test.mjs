...
test('renderer exposes schedules tab, drawer, detail history, settings toggle, and scheduled run badge', () => {
  ...
  assert.match(workspace, /'runs' \| 'schedules'/)
  assert.match(workspace, /ScheduleList/)
  assert.match(workspace, /ScheduleDetail/)
  assert.match(workspace, /ScheduleDrawer/)
  ...
  assert.match(styles, /workflow-tabs/)
